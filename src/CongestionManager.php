...
final class CongestionManager
{
    ...
    /** @var array<int, array{bytes: int, sent_time: float, acked: bool, lost: bool}> */
    ...
    public function __construct(
        ...
        private readonly RTTEstimator $rttEstimator = new RTTEstimator(),
        private readonly ?LossDetection $lossDetection = null,
    ) {
     ...
     */
    /**
     * @param array<int, int> $ackedPackets
     */
     ...
     */
    /**
     * @param array<int, int> $packetNumbers
     */
     ...
     */
    /**
     * @param array<int, int> $lostPackets
     */
     ...
     */
    /**
     * @param array<string, mixed> $oldStats
     */
